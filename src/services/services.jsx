...
export const LikePost = async({encodedToken,postId}) => {
    return axios.post(`/api/posts/like/${postId}`, { headers: { authorization: encodedToken } })
}

export const DislikePost = async({encodedToken,postId}) => {
    return axios.post(`/api/posts/dislike/${postId}`, { headers: { authorization: encodedToken } })
}


export const DeletePost = async ({encodedToken,postId}) => {
    return axios.delete(`/api/user/posts/${postId}`, { headers: { authorization: encodedToken } })
}
...
export const EditUser = async ({encodedToken,userData}) => {
    return axios.post('/api/users/edit',{userData}, {headers: {authorization:encodedToken}});
}
